...
class CarRentalSystem {
    ...
    public void rentCar(Car car, Customer customer, int days) {
        if (car.isAvailable()) {
            ...
            System.out.println("Car is notavailable for rent.");
        }
    }
    ...
    public void returnCar(Car car) {
        ...
        if (rentalToRemove != null) {
            ...
            System.out.println("Car was not rented for customer.");
        }
    }
...
public class Main{
    public static void main(String[] args) {
        ...
        Car car1 = new Car("C001", "Tata", "Punch", 600.0); // Different base price per day for each car
